...
namespace CustomPipelines
{
    internal struct CustomBufferSegmentStack
    {
        ...
        public bool TryPop([NotNullWhen(true)] out CustomBufferSegment? result)
        {
        ...
        public bool Push(CustomBufferSegment item)
        {
        ...
        /// </summary>
        /// <remarks>
        /// <see cref="CustomBufferSegmentStack"/> 객체에서 배열이 쓰기작업할 때마다 공변체크의 코스트를 줄여보니 퍼포먼스가 좋았다고 함
        /// </remarks>
